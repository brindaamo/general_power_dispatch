...
# chosen_plant_names.to_csv('chosen_plants.csv')
...
opti_output = converting_outputs_to_df(plant_units,scheduling_time_blocks,scheduling_dates,plant_names,demand_of_UP_bydate_byhour_units,actuals_data)
