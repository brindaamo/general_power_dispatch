...
from utils import MASTER_DEMAND_TABLE_NAME,DATE_IN_DEMAND_TABLE,MASTER_GENERATING_ASSETS_TABLE,MASTER_PRICING_TABLE
...
class InputModels():
    ...
    """
        ...
        for power_plant in unique_power_plant_names:
            ...
            self.power_plants.append(PlantFeatures(plant_data_row['virtual_asset_name'],plant_data_row['asset_category'],plant_data_row['energy_source'],plant_data_row['capacity_allocated_to_purchaser'],lower_capacity,higher_capacity,plant_data_row['variable_cost_per_unit'],base_or_peak,ramp_up_delta,ramp_down_delta))
...
def main():
    ...
    simulation_yaml_file = "simulation_inputs.yaml"
