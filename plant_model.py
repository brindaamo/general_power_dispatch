class PlantFeatures:
    def __init__(self, name, ownership, fuel_type, capacity,lower_capacity,upper_capacity, average_variable_cost,base_or_peak,ramp_up_delta=None,ramp_down_delta=None,hydro_limit=None):
        self.name = name
